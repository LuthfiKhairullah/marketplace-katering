        ...
        <div class="card-body">
          ...
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="menu_name" value="<?= $menu[0]['menu_name'] ?>">
              </div>
            </div>
            <div class="row mb-3">
              <label for="menu_description" class="col-sm-2 col-form-label">Description</label>
              <div class="col-sm-10">
                <textarea class="form-control" style="height: 100px" name="menu_description"><?= $menu[0]['menu_description'] ?></textarea>
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="number" class="form-control" name="menu_price" value="<?= $menu[0]['menu_price'] ?>">
              </div>
            </div>

            <div class="row mb-3">
              <button type="submit" class="btn btn-warning">Edit Menu</button>
            </div>
          </form>
        </div>
      </div>
